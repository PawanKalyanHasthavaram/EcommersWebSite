...
function UserLocation() {
    ...
    let data = {landmark,buildingName,houseNumber,city,state,country,pincode,addressType,user_id}
    
    
    let addAdress = (e) =>{
        e.preventDefault();
        axios.post(`http://localhost:1729/address/${user_id}`,data)
        .then((res)=>{
            console.log(res);
    ...
    return (
        <div className='UserLocation'>
            <form onSubmit={addAdress} action="">
                ...
                <select value={addressType} onChange={(e)=>{setaddresstype(e.target.value)}} name="" id="">
                    <option>None</option>
                    <option >Home</option>
                ...
                <label htmlFor="">Houseno </label><input type="text" placeholder='Enter the Houseno/floor' required value={houseNumber} onChange={(e) => { sethousenumber(e.target.value) }} />
